"""Web scraper used to create the landmark database CSV.""" 
import os
import sys
...
STARTNEW = True  # Set to False to continue from an existing CSV if scraping is interrupted.
